...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source Stream Snipe - اهلا بك في سورس ديفد ~"
...
echo -e "\033[0;36m"
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By  @BBOBB .|"
echo -e "|  This Is The Source Channel @AAAxA .      |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
cd $THIS_DIR && sudo chmod +x tg
lua Stream Snipe.lua
}
if [ "$1" = "install" ]; then
install
else
